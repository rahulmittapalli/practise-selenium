			...
			if (list.get(i).findElement(By.tagName("ul")) != null) {
				...
				for (int j = 0; j < child.size(); j++) {
					...
					if (child.get(j).getText().equals("Categories")) {
						...
						System.out.println(
								driver.findElement(By.cssSelector("#Categories")).findElements(By.cssSelector("div.treeview>ul")).size());
...
//								}
						...
						driver.findElement(By.xpath("//input[@placeholder='category name']")).sendKeys("HELLO123");
						Thread.sleep(3000);
						driver.findElement(By.xpath("//button[@type='submit']")).click();
						Thread.sleep(3000);
					}
