				...
				if (list.get(i).findElement(By.tagName("ul")) != null) {
					...
					for (int j = 0; j < child.size(); j++) {
						...
						//	Thread.sleep(3000);
							...
							//driver.findElement(By.xpath("//div[@data-placeholder='add key']")).sendKeys("HAHAAHA");
							Thread.sleep(2000);
